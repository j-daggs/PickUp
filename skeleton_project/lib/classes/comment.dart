...
class Comment {
  ...
  /// instance of Comment for testing
  static var comment2 = Comment(DateTime.now(), "Nick B",
      "I'm going to share this event around, would like more people than last time.");

  /// instance of Comment for testing
  static var comment3 = Comment(DateTime.now(), "Jacob J",
      "I've attended this host's pickup events before, they ran it well!");

  /// instance of Comment for testing
  static var comment4 = Comment(
      DateTime.now(), "Jacob U", "I can bring extra equipment if needed.");

  /// instance of Comment for testing
  static var comment5 = Comment(DateTime.now(), "Evan P",
      "Can I bring some extra friends to this event?");
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: const Icon(
            Icons.comment_rounded), // add comment icon to floating button
      ),
    );
  }
